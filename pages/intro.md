...
<div class="row row-cols-1 row-cols-sm-1 row-cols-md-1 row-cols-lg-1">
  <div class="card">
    ...
    <p class="card-text"style='font-size: large' align='left'> Hi, My name is Pankaj. I am a passionate atmospheric scientist and a machine learning enthusiast. During my PhD, I studied the interactions between chemistry and weather/climate using a suite of statistical, machine learning and chemical transport models as a member of <a href="https://www.atmoslabiitkgp.com/" style="text-decoration: underline">ATMOS lab</a> at <a href="http://www.iitkgp.ac.in/" style="text-decoration: underline">Indian Institute of Technology (IIT) Kharagpur</a> under the supervision of <a href="https://www.atmoslabiitkgp.com/spr" style="text-decoration: underline">Dr. Jayanarayanan Kuttippurath</a>. Soon, I'll be joining <a href='https://www.imk-tro.kit.edu/english/3487.php' style="text-decoration: underline">Karlsruhe Institute of Technology (KIT) Germany</a> as a post-doctoral researcher and will be advised by <a href='https://www.imk-tro.kit.edu/english/3521_7223.php' style="text-decoration: underline">Dr. Gholamali Hoshyaripour</a>. My research interests include machine learning, causal network analysis and atmospheric modeling. I have also developed open source tools for modeling and analysis.</p>
